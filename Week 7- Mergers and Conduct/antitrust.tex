...
\begin{align*}
D_{j0}^{\mathcal{M}} =  \frac{\sum_{k \in \mathcal{M}} \frac{\partial\, q_k}{\partial\, p_j}}{\frac{\partial\, q_k}{\partial\, p_j}}
\end{align*}
\begin{itemize}
    ...
    \item You only want to increase prices if $\frac{L}{ \Delta p} > D_{j0}^{\mathcal{M}}$
