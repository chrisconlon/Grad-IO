...
\begin{align*}
\sigma_{ij}\left(G, X_{i}, \lambda_{i}\right)=\frac{\exp \left[U\left(H_{j}, X_{i}, \lambda_{i}\right)\right]}{\sum_{g \in G} \exp \left[U\left(H_{g}, X_{i}, \lambda_{i}\right)\right]}
\end{align*}
And
\begin{align*}
...
&=\left[\frac{1}{1-\sigma_{ij}\left(H_{j}, Y_{i}, Z_{i}, \lambda_{i}\right)}\right]
\end{align*}
\end{itemize}
...
\begin{align*}
 \Delta W_{j}^{E A}(G) &=N \int_{y, \lambda} \Delta W_{j}^{I U}\left(G, Y_{i}, Z_{i}, \lambda_{i}\right) f\left(Y_{i} | \lambda_{i}\right) d Y_{i} d \lambda_{i} \\ &=N \int_{Y, Z, \lambda} \frac{1}{\gamma\left(Y_{i}, Z_{i}\right)} \ln \left[\frac{1}{1-\sigma_{ij}\left(G, Y_{i}, Z_{i}, \lambda_{i}\right)}\right] f\left(Y_{i}, Z_{i}, \lambda_{i}\right) d Y_{i} d Z_{i} d \lambda_{i}
\end{align*}
...
\begin{align*}
\overline{\Delta W}_{j+k}^{E A}(G)&=N \int_{Y, Z, \lambda} \ln \left[\frac{1}{1-\sigma_{ij}\left(G, Y_{i}, Z_{i}, \lambda_{i}\right)-\sigma_{ik}\left(G, Y_{i}, Z_{i}, \lambda_{i}\right)}\right] f\left(Y_{i}, Z_{i}, \lambda_{i}\right) d Y_{i} d Z_{i} d \lambda_{i}\\
...
E U_{i, j, m}&=\sum_{l} \phi_{i, l} \log \left(\sum_{h \in H j} \exp \left(\eta_{h}+x_{h} \hat{\alpha}+x_{h} v_{i, l} \hat{\beta}\right)\right)
\end{align*}
\item $\phi_{i,l}$ is ex-ante probability that consumer $i$ receives diagnosis $l$.
\end{itemize}
\end{frame}
...
\begin{align*}
S_{j, m}\left(H_{j}, H_{-j}\right)=\sum_{i}\left(n_{i} \sigma_{ijm}\left(H_{j}, H_{-j}\right)\left[prem_{j, m}-\phi_{i} \sum_{h \in H j} \sigma_{ih}\left(H_{j}\right)  cost_{h}\right]\right)
\end{align*}
\begin{itemize}
\item $n_i$ population per (ZCTA, age, gender) bin
\item $\phi_i$ admission probability of type $i$ individual
