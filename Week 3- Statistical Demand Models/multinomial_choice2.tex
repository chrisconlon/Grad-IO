...
\begin{itemize}
\item Suppose we got rid of a product $k$ then $\sigma_{ij}(\calJ\setminus k) = \sigma_{ij}(\calJ)\cdot \frac{1}{1- \sigma_{ik}}$.
\item Substitution is just proportional to your pre-existing choice probabilities $\sigma_{ij}$
