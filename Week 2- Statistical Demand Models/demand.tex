...
\begin{document}
\title{Lecutre 2: Demand Estimation (Part one)}
\author{Chris Conlon}
\institute{Grad IO}
\date{\today}
...
\begin{itemize}
\item A \alert{representatitve agent} demand system. 
...
\end{eqnarray*}
So that monopoly markup becomes
\begin{eqnarray*}
p = \frac{ mc}{\rho}
\end{eqnarray*}
\begin{itemize}
...
\begin{eqnarray*}
\log e(u,p) = (1- u) \log \underbrace{a(\mathbf{p})}_{\text{ substistence }} + u \cdot \log \underbrace{b(\mathbf{p})}_{\text{ bliss }}
\end{eqnarray*}
...
\end{eqnarray*}
\begin{itemize}
\item Second line comes from replacing Hicksian expediture $h(p,u)$ with Marshallian demand.
...
\begin{center}
\includegraphics[width=4in]{resources/beer1.png}
\end{center}
\end{frame} 
...
\frametitle{Hausman, et.al (1994)}
\begin{center}
\includegraphics[width=3.5in]{resources/beer2.png}
\end{center}
\end{frame} 
...
\frametitle{Hausman, et.al (1994)}
\begin{center}
\includegraphics[width=3.5in]{resources/beer3.png}
\end{center}
\end{frame} 
...
\frametitle{Hausman, et.al (1994)}
\begin{center}
\includegraphics[width=3in]{resources/beer5.png}
\end{center}
\end{frame} 
...
\begin{itemize}
\item Relatively large own and cross price elasticties.
