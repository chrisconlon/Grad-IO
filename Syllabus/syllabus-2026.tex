...
% Run-in \paragraph headings are typeset when the NEXT paragraph starts, i.e. after
% \AdvanceDate has run, which printed every date one week late. Set the date in a box first.
\newsavebox{\weekdatebox}
\newcommand{\week}[1]{%
  \sbox{\weekdatebox}{\syldate{\today}}% Typeset today's date now
  \paragraph*{\kern-2ex\quad #1, \usebox{\weekdatebox}:}% Print the week number and date
...
\lhead{}
\chead{}
\rhead{\footnotesize Empirical IO- Fall 2026}
\lfoot{}
...
\begin{tabular*}{.93\textwidth}{@{\extracolsep{\fill}}lr}
  ...
  Office Hours: \url{https://calendly.com/ctc5-stern/30min} &  Class Hours: Thursday 1:30pm-4:30pm \\
...
\end{itemize}
\end{itemize}
\week{Week 02} Statistical Models of Product Differentiation. Logit, Nested Logit, Random Coefficients Logit. Welfare.
\begin{itemize}
...
\item Small and Rosen (1981, Ecma). \textit{Applied Welfare Economics with Discrete Choice Models}.
\end{itemize}
\item Endogeneity
\begin{itemize}
...
\item * Conlon and Gortmaker (2020, RAND). \textit{Best Practices for Differentiated Products Demand Estimation with pyBLP}
\end{itemize}
\item Zeros in Market Shares
\begin{itemize}
\item Gandhi, Lu, Shi (2023, QE). \textit{Estimating Demand for Differentiated Products with Zeroes in Market Share Data}.
\item Dub\'e, Horta\c{c}su, Joo (2021). \textit{Random-Coefficients Logit Demand Estimation with Zero-Valued Market Shares}.
\end{itemize}
\item Micro-Data
\begin{itemize}
...
\item Conlon and Gortmaker (2023, WP). \textit{Incorporating Micro Data into Differentiated Products Demand Estimation with pyBLP}.
\end{itemize}
...
\week{Week 05} Merger Analysis, Conduct, and Pass-Through
\begin{itemize}
\item Mergers: Official Stuff
\begin{itemize}
\item 2023 Merger Guidelines \url{https://www.ftc.gov/legal-library/browse/2023-merger-guidelines}
...
\item Pass-Through
\begin{itemize}
\item *Weyl and Fabinger (2013, JPE). \textit{Pass-Through as an Economic Tool: Principles of Incidence under Imperfect Competition}.
...
\item Mr\'azov\'a and Neary (2017, AER). \textit{Not So Demanding: Demand Structure and Firm Behavior}.
\end{itemize}
...
\end{itemize}
\item Conduct, Testing for Conduct, and Common Ownership
\begin{itemize}
\item Genesove and Mullin (1998). \textit{Testing Static Oligopoly Models: Conduct and Cost in the Sugar Industry, 1890-1914}.
\item * Bresnahan (1982). \textit{The Oligopoly Solution Concept is Identified}.
...
\item Backus, Conlon, Sinkinson (2021, AEJ:Micro). \textit{Common Ownership in America: 1980--2017}.
\item Backus, Conlon, Sinkinson (2021, WP) \textit{Common Ownership and Competition in the Ready-To-Eat Cereal Industry}
\item *Duarte, Magnolfi, S{\o}lvsten, Sullivan (2024, QE) \textit{Testing firm conduct}
\end{itemize}
\end{itemize}
...
\item Capps, Dranove, Satterthwaite (2003, RAND). \textit{Competition and market power in option demand markets}
...
\item Whinston: Chapter on Vertical Contracting
\item Conlon Mortimer (2021, JPE). \textit{Efficiency and Foreclosure Effects of Vertical Rebates}.
\end{itemize}
\item Bargaining Models (covered in much greater depth in ECON-GA 1802)
\begin{itemize}
\item Lee, Whinston, Yurukoglu (2021). \textit{Structural empirical analysis of contracting in vertical markets} in Handbook of IO.
\item Crawford, Lee, Whinston, Yurukoglu (2018, ECMA). \textit{Welfare Effects of Vertical Integration in Multichannel Television Markets}
\end{itemize}
\end{itemize}
