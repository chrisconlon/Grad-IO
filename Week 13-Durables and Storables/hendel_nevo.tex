...
&+&\sum_j d_{hjxt} (\alpha_h^p p_{jxt} + \xi_{hjx} + \alpha_h^a a_{jxt} + \epsilon_{hjxt} ) \mid  s_t]\\
...
\begin{eqnarray*}
\Pr(d_1,\ldots,d_t &\mid& p_1,\ldots,p_T) \\
&=& \int \prod_t P(d_t \mid p_t, 
...
\begin{align*}
(\omega_t \mid s_{t-1}) = F(\omega_t \mid \omega_{t-1})
\end{align*}
\end{block}
\begin{itemize}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.9\textwidth]{resources/hntable4.pdf}
\label{gandr1}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.9\textwidth]{resources/hntable5.pdf}
\label{gandr1}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.9\textwidth]{resources/hntable6.pdf}
\label{gandr1}
\end{center}
\end{figure}
\end{frame}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.9\textwidth]{resources/hntable8.pdf}
\label{gandr1}
\end{center}
\end{figure}
\end{frame}
