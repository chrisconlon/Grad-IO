...
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=\textheight]{resources/cpi_chart.png}
\end{center}
\end{figure}
\end{frame}
...
\begin{frame}[plain]{Adoption Curve}
\begin{figure}[htbp]
\begin{center}
\includegraphics[height=\textheight]{resources/s_curve.pdf}
\end{center}
\end{figure}
\end{frame}

\begin{frame}[fragile]{Dynamic Demand  (Gowrisankaran Rysman)}
\begin{center}
\includegraphics[height=\textheight]{resources/gandr1_new.pdf}
\end{center}
\end{frame}

\begin{frame}[fragile]{Dynamic Demand (Gowrisankaran Rysman)}
\begin{center}
\includegraphics[height=\textheight]{resources/gandr2.pdf}
\end{center}
\end{frame}
