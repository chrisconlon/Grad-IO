...
\begin{itemize}
    ...
    \item Vives (1999): Oligpoly Pricing: Old Ideas and New Tools \href{https://www.amazon.com/Oligopoly-Pricing-Old-Ideas-Tools/dp/026272040X}{[Vives]}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Take Prof Nguyen's IO Part II in the Spring
        \item Take Prof Tiew's IO Part III \emph{next} Fall
        \item Take Prof Waldinger's Empirical Market Design in the Spring
...
\begin{itemize}
    ...
    \item Felix Montag (Stern): IO and International Trade, IO of Labor Markets, Pass-Through
    \item Jeff Gortmaker (Stern): Open Source Software, IO of Labor Markets, Computational Methods
...
\begin{itemize}
    ...
    \item Nano Ochoa (Johns Hopkins): Housing Subsidy Design in Chile
    \item Helena Pedrotti (FTC): Social Housing Construction in France
\end{itemize}
\end{frame}
