...
\title [``SCP'']{Structure, Conduct, Performance (and Conjectural Variations)}
\author{C.Conlon}
\institute{Grad IO }
\date{Fall 2026}
\begin{document}
...
\end{itemize}
\item There are still lots of papers that try and infer causality from the cross-industry regression of profits on $HHI$ from before.
