...
\item Vives (1999) is a more modern (and focused) review of oligopoly theory.
...
\item DOJ/FTC (2023 Merger Guidelines) describe markets as:
\begin{itemize}
\item Highly Concentrated: post-merger $HHI > 1800$.
\item Presumed to substantially lessen competition: post-merger $HHI > 1800$ and $\Delta HHI > 100$.
\item Also presumed anticompetitive: merged firm's share $> 30\%$ and $\Delta HHI > 100$ (revives \textit{U.S. v. Philadelphia National Bank}, 1963).
\end{itemize}
\end{itemize}
\end{frame}
