...
\begin{itemize}
\item Prices are not randomly determined, but set strategically by firms who observe the demand curve --- this is exactly the \alert{simultaneity} problem of Working (1927) from Week 1.
\end{itemize}
...
\end{eqnarray*}
\pause
And recover markups and marginal costs:
\begin{eqnarray*}
