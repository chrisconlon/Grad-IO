...
\item Preview: next week we will see that logit demand \alert{is} CES in disguise (Anderson, de Palma, Thisse 1992) --- same constant-markup disease, and the fixes to each translate.
\end{itemize}
\end{frame}
...
Recall our desiderata: a flexible $\Delta(\symbf{p})$ that varies with $\symbf{p}$ and respects consumer theory (WARP, Slutsky Symmetry, etc.).
\begin{itemize}
...
\begin{frame}
\frametitle{Hausman, et.al (1994): Middle Level (Segment Demand)}
\begin{center}
...
\begin{frame}
\frametitle{Hausman, et.al (1994): Bottom Level (Premium Brands)}
\begin{center}
...
\begin{frame}
\frametitle{Hausman, et.al (1994): Bottom Level (Popular-Price Brands)}
\begin{center}
...
\begin{frame}
\frametitle{Hausman, et.al (1994): Overall Elasticities}
\begin{center}
...
\begin{frame}
\frametitle{Other AIDS examples: Chaudhuri, Goldberg, Jia (AER 2006)}
