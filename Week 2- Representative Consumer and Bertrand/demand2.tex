...
\begin{eqnarray*}
\log \frac{s_{ij}(\theta)}{s_{ik}(\theta)} = \symbf{x_{ij}} \beta_j - \symbf{x_{ik}} \beta_k \rightarrow  \symbf{x_i}\cdot(\beta_j - \beta_k)
\end{eqnarray*}
...
\begin{eqnarray*}
s_{ij} = \frac{\exp[\symbf{x_i}\beta_j ]}{1+\sum_k \exp[\symbf{x_i} \beta_k ]} 
\end{eqnarray*}
\begin{itemize}
